...
# (str) Package name
package.name = stk_astro

# (str) Package domain (needed for android/ios packaging)
package.domain = com.stk.astro
...
requirements = python3, kivy, certifi, chardet, filetype, idna, requests, six, urllib3, charset-normalizer
...
# build_dir = /tmp/buildozer_build

# (str) Path to build output (i.e. .apk, .aab, .ipa) storage
# bin_dir = bin_dir = /home/user/hostdir/bin
